...
export function generateMockData() {
  ...
  const baseDocuments: SharedDocument[] = [
    ...
    { id: 'd_released_1_1', channelId: 'case_D-9001', name: 'REFERRAL_ELTON_JOHN.PDF', size: '1.2 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/10/2026, 09:00 AM' },
    { id: 'd_released_2_1', channelId: 'case_D-9002', name: 'REFERRAL_PAUL_MCCARTNEY.PDF', size: '1.4 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/11/2026, 10:15 AM' },
    { id: 'd_released_3_1', channelId: 'case_D-9003', name: 'REFERRAL_MICK_JAGGER.PDF', size: '1.1 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/12/2026, 11:30 AM' },
    { id: 'd_released_4_1', channelId: 'case_D-9004', name: 'REFERRAL_STEVIE_WONDER.PDF', size: '1.3 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/13/2026, 01:45 PM' },
    { id: 'd_released_5_1', channelId: 'case_D-9005', name: 'REFERRAL_DIANA_ROSS.PDF', size: '1.2 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/14/2026, 03:00 PM' },
    { id: 'd_released_6_1', channelId: 'case_D-9006', name: 'REFERRAL_DOLLY_PARTON.PDF', size: '1.5 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/15/2026, 04:15 PM' },
    { id: 'd_released_7_1', channelId: 'case_D-9007', name: 'REFERRAL_TINA_TURNER.PDF', size: '1.3 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/16/2026, 08:30 AM' },
    { id: 'd_released_8_1', channelId: 'case_D-9008', name: 'REFERRAL_FREDDIE_MERCURY.PDF', size: '1.2 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/17/2026, 09:45 AM' },
    { id: 'd_released_9_1', channelId: 'case_D-9009', name: 'REFERRAL_DAVID_GILMOUR.PDF', size: '1.4 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/18/2026, 10:00 AM' },
    { id: 'd_released_10_1', channelId: 'case_D-9010', name: 'REFERRAL_ROBERT_PLANT.PDF', size: '1.1 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/19/2026, 11:15 AM' },
    { id: 'd_released_11_1', channelId: 'case_D-9011', name: 'REFERRAL_JANIS_JOPLIN.PDF', size: '1.3 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/20/2026, 01:30 PM' },
    { id: 'd_released_12_1', channelId: 'case_D-9012', name: 'REFERRAL_JIMI_HENDRIX.PDF', size: '1.4 MB', type: 'pdf', sentBy: 'Me', sentAt: '06/21/2026, 02:45 PM' }
  ];

  // Programmatically add messages for the 12 released base cases
  for (let idx = 1; idx <= 12; idx++) {
    const num = 9000 + idx;
    const caseId = `case_D-${num}`;
    const ref = baseReferrals.find(r => r.id === `D-${num}`);
    if (ref) {
      messages[caseId] = [
        {
